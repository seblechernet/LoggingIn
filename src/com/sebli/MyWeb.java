...
public class MyWeb {
    ...
    public void Menu(){
        ...
        do {
            ...
            switch (choice) {
                case "1": {
                    signUp(userName,input,userId,passWord,wantToAdd,roles,users,roleId,anyOtherRoles);
                    break;
                }
                case "2": {
                    addANewRole(roleId,input,roleName,roles,anyOtherRoles);

                    break;
                }
                case "3": {
                    addARoleToTheUser(roles,users,userId,input,roleId,anyOtherRoles);
                    break;
                }
                case "4": {
                    logIn(userName,input,userId,users,passWord);
                    break;
                }
                case "5": {
                    break;
    ...
    public boolean confirmation(String passWord, Scanner input) {
    ...
    public  Role findRole(long roleId, ArrayList<Role> roles) {
        Role foundRole = null;
    ...
    public  User findUser(long userId, ArrayList<User> users) {
        User foundUser = null;
    ...
    public  boolean validation(String passWord, User user, Scanner input) {
        boolean validate = false;
        do {
            if (passWord.equals(user.getPassWord())) {
                System.out.println("LogedIn successful!!!!");
                validate = true;
            } else {
    ...
    public void signUp(String userName,Scanner input,long userId,String passWord,String wantToAdd,ArrayList<Role> roles,ArrayList<User> users,long roleId,String anyOtherRoles){
        User auser = new User();
    ...
    public void addANewRole(long roleId,Scanner input,String roleName,ArrayList<Role> roles,String anyOtherRoles){
        do {
            Role aRole = new Role();
    ...
    public void addARoleToTheUser(ArrayList<Role> roles,ArrayList<User> users,long userId,Scanner input,long roleId,String anyOtherRoles){
        for (Role eachRole : roles) {
            System.out.printf("Role Name: %s\t\t\t\t\t\t\tRole Id: %s\n",
                    eachRole.getRoleName(), eachRole.getRoleId());
        }
    ...
    public void logIn(String userName,Scanner input,long userId,ArrayList<User> users,String passWord){
